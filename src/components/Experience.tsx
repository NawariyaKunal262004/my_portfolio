...
import { MapPin, Calendar, ExternalLink, Award, BookOpen } from 'lucide-react';
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {certifications.map((cert, index) => (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-r ${cert.glow} rounded-2xl blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-300`}></div>
                ...
                <div className="relative p-8 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300 transform hover:scale-105">
                  <div className="flex items-start gap-4">
                    <div className={`flex-shrink-0 w-12 h-12 bg-gradient-to-br ${cert.glow} rounded-xl flex items-center justify-center`}>
